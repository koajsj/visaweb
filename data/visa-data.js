window.VISA_DATA = [
  {
    country: '日本', region: '亚洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: '短期旅游签证',
  ...
  {
    country: '韩国', region: '亚洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: '短期访问签证',
  ...
  {
    country: '新加坡', region: '亚洲', visaRequiredCN: false, entryRuleCN: '免签（中国普通护照，单次不超过30天）', visaType: '免签入境',
  ...
  {
    country: '泰国', region: '亚洲', visaRequiredCN: false, entryRuleCN: '免签（中国普通护照，单次不超过30天）', visaType: '免签入境',
  ...
  {
    country: '法国（申根）', region: '欧洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: '申根短期 C 签',
  ...
  {
    country: '德国（申根）', region: '欧洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: '申根短期 C 签',
    stay: '180 天内累计 90 天', processing: '约 10-15 个工作日', fee: '约 90 欧元 + 服务费', expedited: false,
    updatedAt: '2026-05-05', validity: '常见按行程给有效期', interview: '可能补料/核验', leadTime: '建议出发前 45-60 天提交',
  ...
  {
    country: '英国', region: '欧洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: 'Standard Visitor',
  ...
  {
    country: '美国', region: '美洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: 'B1/B2 访问签证',
  ...
  {
    country: '加拿大', region: '美洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: 'Visitor Visa (TRV)',
  ...
  {
    country: '澳大利亚', region: '大洋洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: 'Visitor 600',
  ...
  {
    country: '新西兰', region: '大洋洲', visaRequiredCN: true, entryRuleCN: '需签证', visaType: 'Visitor Visa',
